Get Started
===============================
A clear, step-by-step integration flow designed to connect, synchronize, and operate BigCommerce seamlessly with Odoo 19. Explore the complete feature coverage, operational flow, and system behavior in detail by reviewing the official integration overview below:

https://www.odoo.com/r/ecommerce-bigcommerce

BigCommerce Connector Release Notes
===================================

* **Version 19.0.1.6 (2026-07-22)**

  - Optimized inventory synchronization to send stock updates more efficiently from Odoo to BigCommerce.

* **Version 19.0.1.5 (2026-06-29)**

  - Added the "BigCommerce" tag to every customer created from BigCommerce.

* **Version 19.0.1.4 (2026-06-16)**

  - Implemented handling of fulfillments received from BigCommerce using a backorder-based approach to ensure accurate inventory synchronization.
  - Added location on picking based on the location mapped to BigCommerce fulfillment.
